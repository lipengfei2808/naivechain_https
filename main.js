...
var initHttpServer = () => {
  var app = express();
  // https
  var httpsServer = credentials && https.createServer(credentials, app)
  ...
  //https
  credentials && httpsServer.listen(https_port, () => console.log(`Listening https on port: ${https_port}`));
};
